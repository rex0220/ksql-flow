...
- [x] （正式受入・2026-08-25 実施）XL 再実測 → **ジョブ全体 511 → 約 312 回**を確認 — **実測 312 回（全 4 回一致）**・中央値 197.8 秒・cleanup 済み
- [x] 結果を `verification/scale-notes.md` に追記（M 分）。エンジンへ共有済み: docs/kSQLエンジンへの報告-20260825-F7-受入実測.md
