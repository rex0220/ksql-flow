# CLAUDE.md — kSQL Flow 開発エージェント向け案内
...
* 仕様の正は `docs/ksql_flow_spec.md`（リリース版。開発経緯付きの設計書は `docs/internal/ksql_flow_design_v2_9.md`）。エンジン側の事実関係は `docs/internal/kSQLエンジンからの申し送り-20260822-v3710.md`。
